...
class PhoneNumberWidget extends Widget {
    function render($options=array()) {
        ...
        if ($ext || $config['ext']) { ?> </div><div class="form-group"><label><?php echo __('Ext'); ?></label>
            <input type="text" name="<?php
            echo $this->name; ?>-ext" value="<?php echo Format::htmlchars($ext);
                ?>" size="5"/></div><div class="form-group">
        <?php }
    }
...
class CheckboxWidget extends Widget {
    ...
    function render($options=array()) {
        ...
        if (isset($config['classes']))
            $classes = array_merge($classes, (array) $config['classes']);
        ?>
        <label class="<?php echo implode(' ', $classes); ?> checkbox-inline">
...
class FileUploadWidget extends Widget {
    ...
    function render($options) {
        ...
        ?><div id="<?php echo $id;
            ...
            <div class="dropzone"><i class="fa fa-upload"></i>
            <?php echo sprintf(

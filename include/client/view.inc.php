    ...
    <div class="col-md-12">
        ...
        <div class="tick-threads"> 
            ...
            if($ticket->getThreadCount() && ($thread=$ticket->getClientThread())) {
                ...
                foreach($thread as $entry) {
                    ...
                    if($entry['thread_type']=='R' && ($cfg->hideStaffName() || !$entry['staff_id']))
                        $poster = ' ';
                    ?>
                    <table class="thread-entry <?php echo $threadType[$entry['thread_type']]; ?>" cellspacing="0" cellpadding="1" border="0" style="width:100%">
                        <tr><th><div>
            <?php echo Format::db_datetime($entry['created']); ?>
                        ...
                        <tr><td class="threadbody"><div><?php echo Format::clickableurls($entry['body']->toHtml()); ?></div></td></tr>
                        <?php

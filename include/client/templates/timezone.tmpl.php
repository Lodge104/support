...
<select name="<?php echo $TZ_NAME; ?>" id="timezone-dropdown"
        data-placeholder="<?php echo $TZ_PLACEHOLDER; ?>" class="form-control">
...
<?php } ?>
    ...
    <button type="button" class="action-button btn btn-default" onclick="javascript:
...
return false;" style="vertical-align:middle"><i class="fa fa-map-marker"></i> <?php echo __('Auto Detect'); ?></button>
